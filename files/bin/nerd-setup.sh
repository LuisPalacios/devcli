...
configure_gnome_terminal() {
    echo -e "${CYAN}Configurando GNOME Terminal...${NC}"
...
configure_konsole() {
    echo -e "${CYAN}Configurando Konsole...${NC}"
...
configure_xfce4_terminal() {
    echo -e "${CYAN}Configurando XFCE4 Terminal...${NC}"
...
configure_terminator() {
    echo -e "${CYAN}Configurando Terminator...${NC}"
...
configure_alacritty() {
    echo -e "${CYAN}Configurando Alacritty...${NC}"
...
configure_kitty() {
    echo -e "${CYAN}Configurando Kitty...${NC}"
...
configure_vscode() {
    echo -e "${CYAN}Configurando Visual Studio Code...${NC}"
...
configure_macos_terminal() {
    echo -e "${CYAN}Configurando Terminal de macOS...${NC}"

    echo -e "${YELLOW}Para configurar Terminal de macOS:${NC}"
    echo -e "${CYAN}1. Abre Terminal.app${NC}"
    ...
    echo -e ""
    echo -e "${CYAN}O usa este comando para configurar automáticamente:${NC}"
...
configure_iterm() {
    echo -e "${CYAN}Configurando iTerm2...${NC}"

    echo -e "${YELLOW}Para configurar iTerm2:${NC}"
    echo -e "${CYAN}1. Abre iTerm2${NC}"
...
configure_wsl() {
    echo -e "${CYAN}Configurando WSL...${NC}"

    # Intentar configurar Windows Terminal automáticamente
    if command_exists powershell.exe; then
        echo -e "${CYAN}Intentando configurar Windows Terminal automáticamente...${NC}"
...
EOF
    ...
    echo -e "${CYAN}1. Windows Terminal:${NC}"
